...
* `latest` читає історію зверху вниз, але орієнтований на нові події від останнього скану.
...
* Розпізнання форвардів (будувати граф джерел)
